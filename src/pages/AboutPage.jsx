...
import { ArrowLeft, Award, ShieldCheck, MapPin, Phone, Mail, CheckCircle2, HeartHandshake, FileCheck } from 'lucide-react';
      ...
      <div className="container">
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem' }}>
          <h1 style={{ fontSize: '2.6rem', fontWeight: '900', marginBottom: '0.8rem', color: '#FFF' }}>
            About <span style={{ color: 'var(--primary-red)' }}>Gail Harpole</span>
          </h1>
          <p style={{ fontSize: '1.1rem', color: '#CBD5E1', maxWidth: '720px', margin: '0 auto', lineHeight: '1.6' }}>
            GRI Certified REALTOR®, Notary Public & North Texas Property Specialist representing buyers and sellers for over 10 years with Ready Real Estate LLC.
          </p>
        </div>
